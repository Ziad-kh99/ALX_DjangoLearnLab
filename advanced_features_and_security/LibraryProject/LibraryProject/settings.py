...
SECRET_KEY = 'django-insecure-b*!^%wwpzxj%c=4ujr0+5gsy1fnthx0i=_$^_7&7(&1qd0p6v$'
...
# Trust the X-Forwarded-Proto header from the proxy to determine if the request was made over HTTPS:
